...
class TopRatedUnitTest {
    @get:Rule
    val rule = InstantTaskExecutorRule()

    private val testDispatcher = StandardTestDispatcher()
    private lateinit var mockRepositories: RepositoriesImplTopRated
    ...
    fun setUp() {
        ...
        viewModel = TopRatedMoviesViewModel(mockRepositories)
    }
    ...
    @Test
    fun `test getTopRated success`() = runTest {
        // Arrange
        val results = Result(
            adult = false,
        ...
        coEvery { mockRepositories.getTopRatedMovies() } returns response
        ...
        // Assert
        assertEquals(topRated, viewModel.topRated.value)
    }
    @Test
    fun `test getTopRated no movies`() = runTest {
        // Arrange
        val topRated = NowPlayingModel(
            dates = Dates("2025-02-20", "2025-02-19"),
            page = 1,
    ...
    @Test
    fun `test getTopRated error`() = runTest {
        // Arrange
